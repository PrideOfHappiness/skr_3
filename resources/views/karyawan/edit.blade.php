    ...
    <section class="content"> 
        <form action = "{{route('karyawan.update', $karyawan->id)}}" method="post"> 
            ...
            <div class="mb-3">
                ...
                <select name="status" id="status" class="form-control select2-multiple" value="{{ $karyawan->status }}">
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control" id="password" name="password" placeholder="Password" value="{{ $karyawan->password }}" required>
            </div>
